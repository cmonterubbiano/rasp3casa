...
var temp1 = [<?php  echo $temp_arrayAnalog_1; ?>];
var temp2 = [<?php  echo $temp_arrayAnalog_2; ?>];
var temp3 = [<?php  echo $temp_arrayAnalog_3; ?>];
var temp4 = [<?php  echo $temp_arrayAnalog_4; ?>];
...
//	makeDayTemperatureGraphOnTop('2012-12-27', 'plot_container', "temperatura 1", temp1, "temperatura 2", temp2);
	makeDayTemperatureGraphOnTop('<?php echo $ft_titleDate; ?>', 'plot_container', "temp esterna", temp1, "temp cucina", temp2, "temp studio", temp3, "temp camera", temp4);
});
 ...
 function makeDayTemperatureGraphOnTop(dayToRender, divIdToChart, nameData1, dataToChart1, nameData2, dataToChart2, nameData3, dataToChart3, nameData4, dataToChart4){
    ...
    var plot2 = $.jqplot(divIdToChart,[dataToChart1, dataToChart2, dataToChart3, dataToChart4], {
      title:'Temperature - ' + dayToRender + '<?php if($backdays == 1){ echo " - ultime 24 h";} ?>', 
